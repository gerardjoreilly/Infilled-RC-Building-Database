...
set bb2 [expr 750*$mm]; # Beam #2 section height (Concealed)
...
#Column #1 (450x450)
set rC1_top 0.00628; 	  set rC1_web 0; 	set rC1_bot 0.00628; 	  set rC1_shr 0.00250; # Column Section #1
#Column #2 (400x400)
set rC2_top 0.00628; 	  set rC2_web 0; 	set rC2_bot 0.00628; 	  set rC2_shr 0.00250; # Column Section #2
#Column #3 (350x350)
...
set rB1_top 0.00338; 	  set rB1_web 0; 	set rB1_bot 0.00225; 	  set rB1_shr 0.00109;	# Beam Section 1.1
#Beam #2 Internal (500x300)
set rB2_top 0.00441; 	  set rB2_web 0; 	set rB2_bot 0.00338; 	  set rB2_shr 0.00109;	# Beam Section 1.2
#Beam #3 Internal (300x750)
set rB3_top 0.00958; 	  set rB3_web 0; 	set rB3_bot 0.00821; 	  set rB3_shr 0.00109;	# Beam Section 2
