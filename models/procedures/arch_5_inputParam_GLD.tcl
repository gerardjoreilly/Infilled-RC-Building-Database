...
set hb1	[expr 600*$mm];	# Beam section height (Drop)
set bb1	[expr 400*$mm];	# Beam section width  (Drop)
...
#Column #1 (500x500)
set rC1_top 0.00377; 	  set rC1_web 0; 	set rC1_bot 0.00377; 	  set rC1_shr 0.00093; # Column Section #1
#Column #2 (450x450)
set rC2_top 0.00465; 	  set rC2_web 0; 	set rC2_bot 0.00465; 	  set rC2_shr 0.00093; # Column Section #2
#Column #3 (400x400)
set rC3_top 0.00431; 	  set rC3_web 0; 	set rC3_bot 0.00431; 	  set rC3_shr 0.00093; # Column Section #3

#for Beams

#Beam #1 External (600x400)
set rB1_top 0.00524; 	  set rB1_web 0; 	set rB1_bot 0.00393; 	  set rB1_shr 0.00109;	# Beam Section 1
#Beam #2 Internal (600x400)
set rB2_top 0.00654; 	  set rB2_web 0; 	set rB2_bot 0.00524; 	  set rB2_shr 0.00109;	# Beam Section 2
