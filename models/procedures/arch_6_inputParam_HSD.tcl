...
set hb2 [expr 350*$mm]; # Beam #2 section height
...
set rB1_top 0.00403; 	  set rB1_web 0; 	set rB1_bot 0.00310; 	  set rB1_shr 0.00109;	# Beam Section 1.1
#Beam #2 Internal (550x300)
set rB2_top 0.00506; 	  set rB2_web 0; 	set rB2_bot 0.00403; 	  set rB2_shr 0.00109;	# Beam Section 1.2
#Beam #3 Internal
set rB3_top 0.00704; 	  set rB3_web 0; 	set rB3_bot 0.00586; 	  set rB3_shr 0.00109;	# Beam Section 2
