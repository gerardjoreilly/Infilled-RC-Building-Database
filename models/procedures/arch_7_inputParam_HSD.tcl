...
set hb1	[expr 550*$mm];	# Beam #1 section height (Drop)
set bb1	[expr 300*$mm];	# Beam #1 section width  (Drop)

set hb2 [expr 250*$mm]; # Beam #2 section height
set bb2 [expr 750*$mm]; # Beam #2 section width
...
set fyL	430.9;	# Yield strength (in MPa) of longitudinal reinforcement bars
set fuL	458.6;	# Ultimate strength (in MPa) of longitudinal reinforcement bars
set fyV	430.6;	# Yield strength (in MPa) of transverse reinforcement bars
...
#Column #1 (450x450)
set rC1_top 0.00620; 	  set rC1_web 0; 	set rC1_bot 0.00620; 	  set rC1_shr 0.00250; # Column Section #1
#Column #2 (450x450)
set rC2_top 0.00620; 	  set rC2_web 0; 	set rC2_bot 0.00620; 	  set rC2_shr 0.00250; # Column Section #2
#Column #3 (450x450)
set rC3_top 0.00620; 	  set rC3_web 0; 	set rC3_bot 0.00620; 	  set rC3_shr 0.00250; # Column Section #3

#for Beams

#Beam #1 External (550x300)
set rB1_top 0.00669; 	  set rB1_web 0; 	set rB1_bot 0.00527; 	  set rB1_shr 0.00109;	# Beam Section 1.1
#Beam #2 Internal (550x300)
set rB2_top 0.00801; 	  set rB2_web 0; 	set rB2_bot 0.00669; 	  set rB2_shr 0.00109;	# Beam Section 1.2
#Beam #3 Internal (250x750)
set rB3_top 0.01072; 	  set rB3_web 0; 	set rB3_bot 0.00965; 	  set rB3_shr 0.00109;	# Beam Section 2
