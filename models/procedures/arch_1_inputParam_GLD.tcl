...
set hc2 [expr 200*$mm]; # Column #2 section height
set bc2 [expr 200*$mm]; # Column #2 section height
...
#Column #1 (300x300)
set rC1_top 0.004470; 	  set rC1_web 0; 	set rC1_bot 0.004470; 	  set rC1_shr 0.00093; # Column Section #1
#Column #2 (250x250)
set rC2_top 0.004925; 	  set rC2_web 0; 	set rC2_bot 0.004925; 	  set rC2_shr 0.00093; # Column Section #2
...
set rB2_top 0.00308; 	  set rB2_web 0; 	set rB2_bot 0.00308; 	  set rB2_shr 0.00109;	# Beam Section 2
