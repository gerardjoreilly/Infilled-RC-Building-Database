...
# X=4;
infill 		3142 	single 	[list 1412 1422 1421 1411] 	4700. [expr $H*1000] 	$hb1  	$bc3	$hc3 $tw3	$Ecc1 $Ewh3 	$Ewv3 	$Gw3 0.2 $fwv3 	$fwu3 	$fws3 	0.0
infill 		3242 	single 	[list 1422 1432 1431 1421] 	4500. [expr $H*1000] 	$hb1  	$bc3	$hc3 $tw3	$Ecc1 $Ewh3 	$Ewv3 	$Gw3 0.2 $fwv3 	$fwu3 	$fws3 	0.0

# X=5;
infill 		3152 	single 	[list 1512 1522 1521 1511] 	4700. [expr $H*1000] 	$hb1  	$bc3	$hc3 $tw3	$Ecc1 $Ewh3 	$Ewv3 	$Gw3 0.2 $fwv3 	$fwu3 	$fws3 	0.0
infill 		3252 	single 	[list 1522 1532 1531 1521] 	4500. [expr $H*1000] 	$hb1  	$bc3	$hc3 $tw3	$Ecc1 $Ewh3 	$Ewv3 	$Gw3 0.2 $fwv3 	$fwu3 	$fws3 	0.0
