...
# X=3;
infill 		3132 	single 	[list 1322 1332 1331 1321] 	5000. [expr $H*1000] 	$hb1 $bc1 $hc1 $tw3	$Ecc1 $Ewh3 	$Ewv3 	$Gw3 0.2 $fwv3 	$fwu3 	$fws3 	0.0

# X=4;
infill 		3142 	single 	[list 1422 1432 1431 1421] 	5000. [expr $H*1000] 	$hb1 $bc1 $hc1 $tw3	$Ecc1 $Ewh3 	$Ewv3 	$Gw3 0.2 $fwv3 	$fwu3 	$fws3 	0.0
...
# X=3;
infill 		3134 	single 	[list 1324 1334 1333 1323] 	5000. [expr $H*1000] 	$hb1 $bc2 $hc2 $tw3	$Ecc1 $Ewh3 	$Ewv3 	$Gw3 0.2 $fwv3 	$fwu3 	$fws3 	0.0

# X=4;
infill 		3144 	single 	[list 1424 1434 1433 1423] 	5000. [expr $H*1000] 	$hb1 $bc2 $hc2 $tw3	$Ecc1 $Ewh3 	$Ewv3 	$Gw3 0.2 $fwv3 	$fwu3 	$fws3 	0.0
...
# X=3;
infill 		3136 	single 	[list 1326 1336 1335 1325] 	5000. [expr $H*1000] 	$hb1 $bc3 $hc3 $tw3	$Ecc1 $Ewh3 	$Ewv3 	$Gw3 0.2 $fwv3 	$fwu3 	$fws3 	0.0

# X=4;
infill 		3146 	single 	[list 1426 1436 1435 1425] 	5000. [expr $H*1000] 	$hb1 $bc3 $hc3 $tw3	$Ecc1 $Ewh3 	$Ewv3 	$Gw3 0.2 $fwv3 	$fwu3 	$fws3 	0.0
